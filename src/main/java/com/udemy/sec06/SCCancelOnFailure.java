...
public class SCCancelOnFailure {

    private static final Logger log = LoggerFactory.getLogger(SCCancelOnFailure.class);

    public static void main(String[] args) {
        try(StructuredTaskScope taskScope = new StructuredTaskScope.ShutdownOnFailure()){
